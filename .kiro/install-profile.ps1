# Install Perfect PowerShell Profile
...
function prompt {
    ...
    Write-Host " at " -NoNewline -ForegroundColor DarkGray
...
# Save with UTF-8 BOM encoding to preserve emojis
$utf8BOM = New-Object System.Text.UTF8Encoding $true
[System.IO.File]::WriteAllText($PROFILE, $profileContent, $utf8BOM)

Write-Host ""
Write-Host "✅ Profile installed successfully!" -ForegroundColor Green
Write-Host ""
Write-Host "Restart your terminal to see:" -ForegroundColor Yellow
Write-Host "  👻 AWESOME GHOST TERMINAL" -ForegroundColor Cyan
Write-Host "  ╭─ 🚀 javas at PYSHELL 📁 ~/path 👻 (branch) 🕐 time ✅" -ForegroundColor Gray
Write-Host "  ╰─❯" -ForegroundColor Cyan
Write-Host ""
