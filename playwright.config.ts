...
// Disable webServer for local dev - start server manually
// Enable only in CI where we control the environment
const useWebServer = process.env.CI === "true";
...
export default defineConfig({
  ...
  webServer: useWebServer
    ? {
        ...
        reuseExistingServer: true, // Always try to reuse - avoids port conflicts
        timeout: 180_000,
        env: {
          SERVE_STATIC: "1",
          PORT: "3001",
